...
function Signup() {
  ...
  const handleSignup = (e) => {
    ...
    console.log("Sending signup request with:", { username, email, password }); // Debugging
    ...
    axios
      ...
      .catch((error) => {
        ...
        if (error.response && error.response.data && error.response.data.message) {
          enqueueSnackbar(`Signup failed: ${error.response.data.message}`, { variant: "error" });
        } else {
          enqueueSnackbar("Signup failed: An unexpected error occurred", { variant: "error" });
        }
      });
  };
